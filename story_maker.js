function makeStory() {
    ...
    var adjective1 = document.getElementById('adjective1').value.bold().fontcolor("#5191ad");
    var adjective2 = document.getElementById('adjective2').value.bold().fontcolor("#5191ad");
    var noun1 = document.getElementById('noun1').value.bold().fontcolor("#5191ad");
    var noun2 = document.getElementById('noun2').value.bold().fontcolor("#5191ad");
    var noun3 = document.getElementById('noun3').value.bold().fontcolor("#5191ad");
    var noun4 = document.getElementById('noun4').value.bold().fontcolor("#5191ad");
    var noun5 = document.getElementById('noun5').value.bold().fontcolor("#5191ad");
    var noun6 = document.getElementById('noun6').value.bold().fontcolor("#5191ad");
    var noun7 = document.getElementById('noun7').value.bold().fontcolor("#5191ad");
    var pastTenseVerb = document.getElementById('pastTenseVerb').value.bold().fontcolor("#5191ad");
    var pluralNoun1 = document.getElementById('pluralNoun1').value.bold().fontcolor("#5191ad");
    var pluralNoun2 = document.getElementById('pluralNoun2').value.bold().fontcolor("#5191ad");
    var pluralNoun3 = document.getElementById('pluralNoun3').value.bold().fontcolor("#5191ad");
    var pluralBodyPart = document.getElementById('pluralBodyPart').value.bold().fontcolor("#5191ad");
